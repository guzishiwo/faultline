defmodule FaultlineWeb.AlertLive.Index do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto grid w-full max-w-7xl gap-6 xl:grid-cols-[minmax(0,1fr)_24rem]">
        <section class="space-y-6">
          <header class="flex flex-col gap-4 border-b border-base-300 pb-5 lg:flex-row lg:items-start lg:justify-between">
            ...
            <.link
              ...
              class="inline-flex w-fit items-center gap-2 rounded-lg border border-base-300 px-3 py-2 text-sm font-semibold text-base-content/70 transition hover:-translate-y-0.5 hover:bg-base-200 hover:text-base-content"
            >
              Issues <.icon name="hero-arrow-right" class="size-4" />
            </.link>
          </header>
