          ...
          <div id="selected-event-detail" class="space-y-4">
            ...
            >
              ...
              <div class="space-y-5 p-5">
                <.collapsible_section id="event-overview" title="Overview" border={false}>
                ...
                <.collapsible_section id="event-stacktrace" title="Stacktrace">
                  <.stacktrace
                ...
                <.collapsible_section id="event-context" title="Context">
                ...
                <.collapsible_section id="event-sdk" title="SDK and runtime">
                  <div class="grid gap-5 lg:grid-cols-2">
    ...
    <section>
      ...
      <div class="mt-2 grid gap-1 text-sm">
        ...
        <div :for={{key, value} <- @values} class="grid grid-cols-[7rem_minmax(0,1fr)] gap-2">
          ...
          <span class="break-words text-base-content">{format_detail(value)}</span>
        </div>
      </div>
    </section>
    """
